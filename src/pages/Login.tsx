...
import { loginAsync, clearError } from "../store/store";
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
        ...
        <label className={styles.field}>
          ...
          <Controller
            ...
            render={({ field }) => <Input {...field} type="email" placeholder="Enter your email" size="large" />}
          />
        ...
        <div style={{ marginTop: 16, textAlign: "center" }}>
          <p style={{ margin: 0, color: "#666" }}>Demo credentials: admin@gmail.com / Admin2025&</p>
        </div>
      </form>
    </div>
  );
