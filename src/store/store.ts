...
export const { addProduct, updateProduct, deleteProduct, toggleFavourite } = productsSlice.actions;
...
const ordersSlice = createSlice({
  ...
  reducers: {
    ...
    updateStatus: (state: Order[], action: PayloadAction<{ id: string; status: Order["status"] }>) => {
...
const profileSlice = createSlice({
  ...
  reducers: {
    updateProfile: (_state: Profile, action: PayloadAction<Profile>) => action.payload,
  },
});
